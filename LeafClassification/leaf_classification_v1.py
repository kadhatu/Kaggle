...
# Stratification is necessary for this dataset because there's a relatively large number
# of classes (100 classes for 990 samples).
...
# draw picture for Accuracy and Loss
...
# Predict Test Set using the best performed Classifier
